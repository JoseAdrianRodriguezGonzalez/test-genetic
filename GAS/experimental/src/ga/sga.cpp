...
void algoritmogeneticsimple::Elitismo(void) {
  ...
  float algoritmogeneticsimple::FuncionObjetivo(unsigned int _id_individuo) {
    return this->funcion_objetivo(
        this->poblacion[_id_individuo].valores_reales);
  ...
  void algoritmogeneticsimple::CruzamientoDoblePunto(
      double _probabilidad_cruza) {
